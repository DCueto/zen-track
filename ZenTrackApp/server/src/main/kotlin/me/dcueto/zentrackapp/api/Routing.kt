...
fun Application.configureRouting(authService: AuthService, workspaceService: WorkspaceService, projectService: ProjectService, googleOAuthService: GoogleOAuthService) {
    routing {
